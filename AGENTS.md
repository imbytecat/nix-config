...
Issue 与 PRD 以 markdown 文件形式存放在本仓 `.scratch/<feature>/` 下。详见 `docs/agents/issue-tracker.md`。
...
单上下文（single-context）：仓库根目录一个 `CONTEXT.md` + `docs/adr/`。详见 `docs/agents/domain.md`。
